...
Analizador::Analizador() {                 
    ...
    ogrilla_on = new Fl_Button(391,374,35,27,"");      //Botón que activa la grilla del instrumento.
    ...
    odesHorizontal->angles(30,330);
    odesHorizontal->box(FL_NO_BOX);
    odesHorizontal->range(0,400);
    ...
    oboxNomAnalizador = new Fl_Box(12,374,334,27,"ANALIZADOR LÓGICO");
    oboxNomAnalizador->box(FL_ENGRAVED_FRAME);
    oboxNomAnalizador->labelfont(FL_HELVETICA_BOLD);
    oboxNomAnalizador->labelsize(20);
    ...
    //--- Box para las imagenes de los botones----//
    
    oboxOnAnalizador = new Fl_Box(351,381,35,27,"");
    oboxgrilla = new Fl_Box(391,381,35,27,"");
        
    //--- Cargar las imagenes de los botones en el box---//
    
    iOnAnalizador = new Fl_PNG_Image("onanalizador.png"); 
    oboxOnAnalizador->image(iOnAnalizador);
    
    igrilla = new Fl_PNG_Image("gridAnalizador.png"); 
    oboxgrilla->image(igrilla);
    ...
    oana_on = new Fl_Button(351,374,35,27,"");               //Botón para prender o apagar el instrumento
    ...
    odesHorizontal->callback(cb_horizontal,this);
...
void Analizador::cb_scroll_cursor_in() { 
    ...
    int ipos = int((odesHorizontal->value()/20));                                      
...
void Analizador::cb_horizontal_in() {
    otextoMuestra->inum_inicial = int(odesHorizontal->value()/20);   //Desplazar al mismo tiempo que las graficas el número de muestra
    
    //Cambiar el dato con el que se inicia las gráficas a la izquierda de la pantalla del analizador
    apantallaCh1->ipos_x = int(odesHorizontal->value());
    apantallaCh1->redraw();
    apantallaCh2->ipos_x = int(odesHorizontal->value());
    apantallaCh2->redraw();
    apantallaCh3->ipos_x = int(odesHorizontal->value());
    apantallaCh3->redraw();
    apantallaCh4->ipos_x = int(odesHorizontal->value());
    apantallaCh4->redraw();
    apantallaCh5->ipos_x = int(odesHorizontal->value());
    apantallaCh5->redraw();
    apantallaCh6->ipos_x = int(odesHorizontal->value());
    apantallaCh6->redraw();
    apantallaCh7->ipos_x = int(odesHorizontal->value());
    apantallaCh7->redraw();
    apantallaCh8->ipos_x = int(odesHorizontal->value());
    apantallaCh8->redraw();
